  ...
  static void AddStartPictures(Database database)
  {
    if (database.IsNewlyCreated())
    {
      var startArticals = new Picture[] {
        ...
        new Picture(
          "https://i.ibb.co/xSMgmgLq/IMG-20241231-WA0095.jpg",
          "Дорогой наш, любимый Толя, мы тебя очень любим,  ты наш очень дорогой человек, мы семья и с тобой мы счастливы. Спасибо,  что ты с нами, что ты у нас есть и что ты такой замечательный! מזל טוב !רק שתהיה בראי לעוד הרבה שניים, וקולה שלא תגמר. המון חיבוקים ודיגדוגים. תודה שאתה איתנו! "
        )
      };
